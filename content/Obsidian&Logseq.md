...
publish: true
---
@ [[./Obsidian|Obsidian]] @ Logseq 笔记应用的选择  
...
- 大纲笔记 适合灵活组织列表项之间的从属关系，文档笔记则需要用各级标题来切分。  
...
- [[Obsidian&Logseq|Obsidian&Logseq]]  
	...
	- 还是再试用 logseq 一段时间吧，Logseq 和 子弹笔记 很像。obsidian 恐沦为同步工具和笔记文件浏览器😂。  
		- logseq 的理念其实与 子弹笔记 一脉相承。  
	- 还是用回 Obsidian。  
