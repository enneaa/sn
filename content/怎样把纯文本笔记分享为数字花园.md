...
date: 2025-03-27
---
[[./发布|发布]] 怎样做 [[./博客搭建方案|博客搭建方案]] [[./数字花园|数字花园]]  
...
- 怎样把纯文本笔记分享为数字花园  
	...
	- 使用 Quartz 将 Github 仓库部署在 Cloudflare ，把笔记转化为网页并发布。  
- 需要的应用及服务  
...
- 搭建流程  
	- 创建自己的 Github 仓库。  
		- 在 Github 中 fork [原项目](https://github.com/jackyzha0/quartz)，在自己的 Github 中创建原项目的分支。  
	...
	- 将 Obsidian 笔记上传到 Github 仓库根目录下的 `content` 的文件夹。  
		- 本站采取的方式  
			- 通过 [Obsidian Enveloppe插件](https://github.com/Enveloppe/obsidian-enveloppe) 将笔记上传到 Github 仓库指定位置。  
